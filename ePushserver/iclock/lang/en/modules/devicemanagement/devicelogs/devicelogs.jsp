...
<link href="css/devicelogs.css" rel="stylesheet" type="text/css" />

</head>
<body oncopy="return false" oncut="return false" onpaste="return false" onload="JavaScript:DEVICELOGS.InitPage()"
	onunload="JavaScript:DEVICELOGS.ClosePage()">
	...
	<div class="container">
		...
		<div class="jqgrid-filter"  id="form_filter" style="display:none;">
			...
			<div class="row" align="center">
				<div class="col-xs-2">
					<input type="checkbox" id="chb_autorefresh" style="vertical-align: middle;" onclick="JavaScript:DEVICELOGS.AutoRefresh_Clicked()">
				</div>
				<div class="col-xs-1"></div>
				<div class="col-xs-2">
				...
				<div class="col-xs-1">
					<button class="btn btn-default btn-sm" data-toggle="tooltip" data-placement="left" title="Please click here to search.." type="button"
						onclick="JavaScript:DEVICELOGS.SearchData_Clicked(1)">
                ...
                <div class="form-group">
                    <table class="lbl-select">
                        <tr>
                            ...
                            <td></td>
                            <td colspan="2" class="input-label"><p>EMPLOYEE LOG DETAILS</p></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td><p align="left" class="input-label">Name</p></td>
                            <td><input type="text" class="form-control input-sm" readonly id="txt_Name" readonly></input></td>
                        </tr>
                        <tr>
                            <td></td>
	...
	<script src="../../../../../js/ds/DeviceLogs.js"></script>
	<script src="../../../../../js/ds/ComboBoxList.js"></script>
	<script src="../../../../../js/sweetalert.min.js"></script>
	<script src="../../../../../js/popup.js"></script>
	<script src="js/msg.js"></script>
	<script src="js/devicelogs.js"></script>
