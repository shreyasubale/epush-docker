...
<link href="css/devicecommands.css" rel="stylesheet" type="text/css" />

</head>
<body oncopy="return false" oncut="return false" onpaste="return false" onload="JavaScript:DEVICECOMMANDS.InitPage()"
	onunload="JavaScript:DEVICECOMMANDS.ClosePage()">

	<div class="container">
		<div class="jqgrid-header ui-widget-header">Device Commands</div>
			...
			<div class="row" align="center">
				...
				<div class="col-xs-1">
					<button class="btn btn-default btn-sm" data-toggle="tooltip" data-placement="left" title="Please click here to search.." type="button"
						onclick="JavaScript:DEVICECOMMANDS.SearchData_Clicked()">
