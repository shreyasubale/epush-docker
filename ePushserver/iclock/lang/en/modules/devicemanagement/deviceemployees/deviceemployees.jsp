...
<link href="css/deviceemployees.css" rel="stylesheet" type="text/css" />

</head>
<body oncopy="return false" oncut="return false" onpaste="return false" onload="JavaScript:DEVICEEMPLOYEES.InitPage()"
	onunload="JavaScript:DEVICEEMPLOYEES.ClosePage()">

	<div class="container">
		<div class="jqgrid-header ui-widget-header">Device Employees</div>
			...
			<div class="row" align="center">
				...
				<div class="col-xs-1">
					<button class="btn btn-default btn-sm" data-toggle="tooltip" data-placement="left" title="Please click here to search.." type="button"
						onclick="JavaScript:DEVICEEMPLOYEES.SearchData_Clicked()">
    ...
    <script src="../../../../../js/ds/DeviceCommands.js"></script>
    <script src="../../../../../js/ds/ComboBoxList.js"></script>
    <script src="../../../../../js/sweetalert.min.js"></script>
    <script src="js/msg.js"></script>
    <script src="js/deviceemployees.js"></script>
